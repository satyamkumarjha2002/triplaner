...
export class VotesService {
  ...
  async createVote(tripId: string, activityId: string, createVoteDto: CreateVoteDto, user: User): Promise<Activity> {
  ...
  async removeVote(tripId: string, activityId: string, userId: string): Promise<Activity> {
    // Check if user has access to the activity
